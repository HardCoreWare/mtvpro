...
echo $hora_actual; ?></p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                         <center></br><?php $v1=$Qrs*0.05; 
                            $n=number_format($v1, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center></br><?php  $v2=$Qrs*0.85; 
                            $n=number_format($v2, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center></br> <?php  $v3=$Qrs*0.1; 
 ...
 BONO 
                   ...
                   <td>
                         <center><?php $v4=$Qrs1*0.05; 
                            $n=number_format($v4, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v5=$Qrs1*0.85; 
                            $n=number_format($v5, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v6=$Qrs1*0.1; 
...
CUOTAS AL I.M.S.S.
                   ...
                   <td>
                         <center><?php $v7=$Qrs2*0.05; 
                            $n=number_format($v7, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v8=$Qrs2*0.85; 
                            $n=number_format($v8, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v9=$Qrs2*0.1; 
 ...
 APORTACIPONES AL INFONAVIT
                    ...
                    <td>
                     ...
                     <td>
                         <center><?php $v10=$Qrs3*0.05; 
                            $n=number_format($v10, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v11=$Qrs3*0.85; 
                            $n=number_format($v11, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v12=$Qrs3*0.1; 
...
<tr>
 ...
 VALES DE DESPENSA
                    ...
                    <td>
                         <center><?php $v13=$Qrs4*0.05; 
                            $n=number_format($v13, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v14=$Qrs4*0.85; 
                            $n=number_format($v14, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v15=$Qrs4*0.1; 
...
GRATIFICACIONES
 ...
 2% SOBRE NOMINA E IMP. ESTATALES
                    ...
                    <td>
                         <center><?php $v19=$Qrs7*0.05; 
                            $n=number_format($v19, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v20=$Qrs7*0.85; 
                            $n=number_format($v20, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v21=$Qrs7*0.1; 
 ...
 BONO ACTUACION
                    ...
                    <td>
                         <center><?php $v22=$Qrs8*0.05; 
                            $n=number_format($v22, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v23=$Qrs8*0.85; 
                            $n=number_format($v23, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v24=$Qrs8*0.1; 
                ...
                <tr>
                    ...
                    <td>
                         <center><?php $v25=$Qrs9*0.05; 
                            $n=number_format($v25, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v26=$Qrs9*0.85; 
                            $n=number_format($v26, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v27=$Qrs9*0.1; 
...
GASTOS NO DEDUCIBLES POR EXEDENTES DE GASTOS DE VA
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td>
                         <center><?php $v52=$Qrs25*0.05; 
                            $n=number_format($v52, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v53=$Qrs25*0.85; 
                            $n=number_format($v53, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v54=$Qrs25*0.1; 
...
OTROS
                    ...
                    <td>
                         <center><?php $v88=$Qrs38*0.05; 
                            $n=number_format($v88, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v89=$Qrs38*0.85; 
                            $n=number_format($v89, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v90=$Qrs38*0.1; 
...
CONSUMOS EN RESTAURANTES (LOCALES)</td>
                    ...
                    <td>
                         <center><?php $v115=$Qrs47*0.05; 
                            $n=number_format($v115, 0, '.', ',');
                            echo($n); ?>
                          </center> 
                    </td>
                    <td>
                        <center><?php  $v116=$Qrs47*0.85; 
                            $n=number_format($v116, 0, '.', ',');
                            echo($n);
                         ?> </center>
                    </td>
                    <td>
                        <center> <?php  $v117=$Qrs47*0.1; 
